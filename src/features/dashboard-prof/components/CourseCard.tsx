        ...
        <div className="p-5 flex flex-col flex-1">
          ...
          <div className="grid grid-cols-2 gap-3 pt-4 border-t border-edu-border/50">
            <button
                ...
                className="py-2 px-4 rounded-xl bg-edu-bg/50 text-edu-muted-fg font-medium text-sm hover:bg-edu-bg transition text-center"
            >
              Editează
            </button>
            ...
            <button
                ...
                className={`py-2 px-4 rounded-xl font-medium text-sm transition text-center ${
                    status === "Activ"
                        ? "bg-edu-accent/30 text-edu-foreground hover:bg-edu-accent/50" // Butonul verde subtil
                        : "bg-edu-primary/10 text-edu-primary hover:bg-edu-primary/20" // Butonul pentru Draft
                }`}
            >
              {status === "Activ" ? "Statistici" : "Publică"}
            </button>
          </div>
        </div>
      </div>
