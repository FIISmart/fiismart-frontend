...
export function ProfDashboardNavbar() {
  ...
  return (
    <nav className="relative h-20 w-full bg-[#F4EFE8] flex items-center justify-center px-4 md:px-12 border-b border-black/[0.03]">
      <div className="max-w-[1280px] w-full flex items-center justify-between">
        ...
        <div className="hidden lg:flex gap-10 text-[15px] font-semibold text-[#5a5470]">
          <Link to="/professor/dashboard" className="hover:text-[#9b8ec7] transition-colors">
            Dashboard
          </Link>
          <Link to="/professor/courses" className="hover:text-[#9b8ec7] transition-colors">
            Cursuri
          </Link>
        </div>
